...
const DEMO_AUDIO_FILE =
  "f7974ff5-fb84-47aa-b255-198874396a0c_1768662992629.m4a";
...
async function main() {
  ...
  console.log(
    `✅ Created ${realisticUsers.length} realistic users for search testing`
  );
  ...
  if (realUser) {
    ...
    console.log(
      `⚠️ Real user (${REAL_USER_EMAIL}) not found. Sign in first to create the user.`
    );
  }
